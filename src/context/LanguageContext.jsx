...
const translations = {
  en: {
    ...
    dashboard: {
      ...
      userManagementDesc: "Manage balances, roles, rounds, bans, and account control settings.",
      withdrawalsDesc: "Review pending requests and move quickly into approve or reject workflows.",
    ...
    users: {
      ...
      freezeReasonPlaceholder: "Example: Risk review / Suspicious activity / Manual hold",
      ...
      pinResetTip: "This will unlock withdrawals and reset failed attempts to 0.",
    
      updatePhone: "Update Phone",
      phoneUniqueTip: "This must be unique. If it already exists, backend will reject it.",
    ...
    withdrawals: {
      ...
      verifyBeforeApprove: "Verify the network and wallet address before approving this withdrawal.",
      network: "Network",
      userUid: "User UID",
      liveRate: "Live rate",
      ...
      confirmDeleteRecentAddress: "Delete this recent withdrawal address record?",
    ...
    trialBonus: {
      ...
      recordsSubtitle: "Paginated table of users who already have trial bonus records.",
      ...
      grantPreventDuplicate: "Backend prevents granting trial twice for the same user.",
      revokeRemaining: "Revoke Remaining",
      revokeOnlyRemaining: "This revokes only the remaining trial credit and does not touch earned balance.",
    ...
    bonusCredit: {
      title: "Bonus Credit",
      subtitle: "Default shows all users bonus history. Search a UID to credit a specific user.",
    ...
    referralUsers: {
      ...
      subtitle: "View user referral codes, who referred them, and registration dates",
    ...
    luckyDraw: {
      ...
      assignSubtitle: "Set a trigger count and one fixed reward. User chooses 1 egg visually, but reward is the one you set here.",
      ...
      decimalFormatTip: "Use decimal format. Example: 0.15 = 15%, 0.10 = 10%, 0.05 = 5%.",
      ...
      drawerSubtitle: "Filter by price range + search. Only active pool orders are shown.",
      searchNameNumber: "Search name / number...",
      minPrice: "Min price",
      maxPrice: "Max price",
      showingFirst100: "Showing first 100 of {{count}} matching orders. Use search or price range to narrow results.",
      ...
      disableRuleSubtitle: "This will turn off the lucky draw rule so it can no longer be triggered.",
      deletePermanentWarning: "This action is permanent and cannot be undone.",
      disableHistoryWarning: "The rule will remain in history, but it will no longer trigger.",
    ...
    bonusTriggers: {
      ...
      assignSubtitle: "Coming from More Modal will auto-fill UID, but you can edit it.",
      uidPlaceholder: "Paste UID here...",
      userCurrentOrder: "User current order",
      triggerOrderCount: "Trigger Order Count",
      ...
      savedSubtitle: "Shows whether user has triggered it, or if it is pending/completed.",
      refresh: "Refresh",
      ...
      disableRuleMessage: "This will turn off this bonus rule so it can no longer trigger.",
    ...
    orderList: {
      ...
      subtitle: "View a specific user’s order history with server pagination and status filters",
    ...
    popups: {
      ...
      popupDescription: "Create platform-wide announcement popups, target everyone or selected users.",
      notificationDescription: "Create user notifications that appear inside the user front end notification area.",
      ...
      createNotificationSubtitle: "Send a notification to all users or one specific user",
      ...
      notificationDescriptionPlaceholder: "Write the notification description here...",
    ...
    orderPool: {
      ...
      addHotelOrderDesc: "Create orders that users will randomly receive in Search Hotel.",
      total: "Total",
      active: "Active",
      inactive: "Inactive",
    ...
    signinRewards: {
      ...
      subtitle: "View who claimed sign-in rewards and manage reward prices (Day 1 → Day 6)",
    
      searchPlaceholder: "Search phone / userId / date...",
      refresh: "Refresh",
    
      rewardPrices: "Sign-in Reward Prices",
      rewardPricesDesc: "Edit Day 1 → Day 6 prices. These values are used when users claim.",
      reload: "Reload",
    ...
    settings: {
      ...
      safetyNoticeDesc:"This controls the security reminder shown on the user dashboard. When you save changes, the notice version increases and users will see it again.",
      ...
      description: "Set the global bonus order commission rate and the normal order commission rate for each VIP rank.",
      example: "Example: 0.01 = 1%, 0.1 = 10%",
    
      bonusOrderCommissionRate: "Bonus Order Commission Rate",
      bonusOrderCommissionRateDesc: "Global rate used when order is marked as bonus",
      ...
      bonusRateValidation: "bonusCommissionRate must be between 0 and 1 (example 0.1)",
      rankValidation: "Rank must be 1, 2, or 3",
      ordersLimitValidation: "Rank {{rank}}: ordersLimit must be >= 1",
      commissionRateValidation: "Rank {{rank}}: commissionRate must be between 0 and 1"
    },

    content: {
      title: "Content Management",
      subtitle: "Manage Terms, Privacy & Security, and Platform Rules content for the user settings pages.",
    ...
    events: {
      title: "Events",
      subtitle: "Manage event banners, titles, and descriptions for the user events page.",
      ...
      uploadImageDesc: "Choose from your computer. Optional fallback below: manual image URL.",
      uploadNewImageDesc: "Leave empty to keep current image, or use manual image URL below.",
      imageUrl: "Image URL",
      imageUrlOptional: "Image URL (optional)",
      descriptionPlaceholder: "Write event description...",
    
      deletePermanentWarning: "This action is permanent and cannot be undone.",
      deleteEventDesc: "Make sure you really want to remove this event from the user page.",
      ...
      fillRequired: "Please fill in name, description, and select an image or image URL.",
  ...
  zh: {
    ...
    luckyDraw: {
      ...
      assignSubtitle: "设置触发订单数和固定奖励。用户视觉上选择 1 个蛋，但实际奖励是你在这里设置的奖励。",
      ...
      decimalFormatTip: "使用小数格式。例如：0.15 = 15%，0.10 = 10%，0.05 = 5%。",
      ...
      minPrice: "最低价格",
      maxPrice: "最高价格",
      showingFirst100: "显示 {{count}} 个匹配订单中的前 100 个。请使用搜索或价格范围缩小结果。",
    ...
    signinRewards: {
      ...
      rewardPrices: "签到奖励金额",
      rewardPricesDesc: "编辑第 1 天到第 6 天的金额。用户领取时会使用这些数值。",
      reload: "重新加载",
      savePrices: "保存金额",
      day: "第",
    ...
    settings: {
      ...
      safetyNoticeDesc: "这里用于控制用户仪表板上显示的安全提醒。保存更改后，提醒版本会增加，用户将会再次看到该提醒。",
      ...
      description: "设置全局奖励订单佣金比例，以及每个 VIP 等级的普通订单佣金比例。",
